...
class Mttb:
    ...
    def act(self):
        try:
            ...
            data = {
                "mtToken": self.ck,
                "deviceUUID": '0000000000000A3467823460D436CAB51202F336236F6A167192373531935811',
                "mtUserId": self.usid,
    ...
    def get_ids(self):
        try:
            ...
            data = {
                "externalStr": "",
                "riskParams": {
                    "uuid": "0000000000000A79837DA33B34SB7959B6D42F3D103B6C131689451622912831",
		            "platform": 4,
		            "fingerprint": "",
		            "version": "12.15.407",
		            "app": 0,
    ...
    def post_id(self):
        try:
            url = 'https://game.meituan.com/mgc/gamecenter/front/api/v1/mgcUser/task/receiveMgcTaskReward'#网址换成完整网络地址
            data = {
                "taskId": self.id,
                "externalStr": "",
                "riskParams": {
                    "uuid": "0000000000000E79837DA33B34DA7959D6D42F5D103E6A169991218913365693",
		            "platform": 4,
		            "fingerprint": "",#fingerprint后面要填入自己抓包参数应该就可以获取团币
		            "version": "12.15.407",
		            "app": 0,
		            "cityid": "582"
                }
